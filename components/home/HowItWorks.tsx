export default function HowItWorks() {
  return (
    <section className="py-20 px-4 bg-eggshell">
      <h2 className="text-3xl sm:text-5xl font-black tracking-tighter text-center mb-12">Get started in minutes</h2>
      <div className="max-w-3xl mx-auto">
        <div className="relative">
          ...
          <div className="mb-8 flex items-center w-full">
            ...
            <div className="pl-8">
              <h3 className="font-bold text-2xl">1. Connect your channels</h3>
          ...
          <div className="mb-8 flex items-center w-full">
            <div className="bg-magenta rounded-full h-8 w-8 z-10"></div>
            <div className="pl-8">
              <h3 className="font-bold text-2xl">2. Set up auto-replies</h3>
          ...
          <div className="mb-8 flex items-center w-full">
            <div className="bg-magenta rounded-full h-8 w-8 z-10"></div>
            <div className="pl-8">
              <h3 className="font-bold text-2xl">3. Watch Nexus Flow handle your DMs</h3>
          ...
          <div className="flex items-center w-full">
            <div className="bg-magenta rounded-full h-8 w-8 z-10"></div>
            <div className="pl-8">
              <h3 className="font-bold text-2xl">4. See tokens and cost update in real time</h3>
